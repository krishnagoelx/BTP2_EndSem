...
DARP2016Setup = AmT.loadTestSetup('/Users/krishna/amiet_tools-1/DARP2016_TestSetup.json')
...
DARP2016Airfoil = AmT.loadAirfoilGeom('/Users/krishna/amiet_tools-1/DARP2016_AirfoilGeom.json')
...
if save_fig:
    plt.savefig('/Users/krishna/amiet_tools-1/whyresults/AirfoilBeamf_' + f0_str + 'Hz.png', dpi=200)
plt.show()
