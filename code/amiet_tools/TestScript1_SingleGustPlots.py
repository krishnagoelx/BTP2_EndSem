...
ax_chord.plot(xs_normalized, np.abs(delta_p1_midspan), 'b-', linewidth=2, 
              label=f'|k_y/k_psi^(crit)| = {np.abs(ky/Ky_crit):.2f}')
...
ax1_airfoil.set_title('Re{Delta p(x_s, y_s)} [a.u.]', fontsize=18)

ax1_airfoil.set_yticks([-d, 0, +d])
ax1_airfoil.set_yticklabels(['-d', '0', '+d'], fontsize=18)
ax1_airfoil.set_xticks([-b, 0, b])
ax1_airfoil.set_xticklabels(['-b', '0', '+b'], fontsize=18)

ax1_airfoil.set_ylim(-1.1*d, 1.1*d)
ax1_airfoil.set_xlabel('x_s', fontsize=18)
ax1_airfoil.set_ylabel('y_s', fontsize=18)
plt.colorbar(re_p)
...
ax2_airfoil.set_title('|Delta p(x_s, y_s)| [dB]', fontsize=18)

ax2_airfoil.set_yticks([-d, 0, +d])
ax2_airfoil.set_yticklabels(['-d', '0', '+d'], fontsize=18)
ax2_airfoil.set_xticks([-b, 0, b])
ax2_airfoil.set_xticklabels(['-b', '0', '+b'], fontsize=18)

ax2_airfoil.set_ylim(-1.1*d, 1.1*d)
ax2_airfoil.set_xlabel('x_s', fontsize=18)
plt.colorbar(abs_p)
...
contour_super = ax_super.pcolormesh(x_mesh, y_mesh,
                                   ...
                                   vmax=0, vmin=-30)
ax_super.axis('equal')
ax_super.set_title('Supercritical gust: |k_y| < k_y^crit', fontsize=16)
ax_super.set_xlabel('x_s', fontsize=14)
ax_super.set_ylabel('y_s', fontsize=14)
ax_super.set_yticks([-d, 0, +d])
ax_super.set_yticklabels(['-d', '0', '+d'], fontsize=14)
ax_super.set_xticks([-b, 0, b])
ax_super.set_xticklabels(['-b', '0', '+b'], fontsize=14)
ax_super.set_ylim(-1.1*d, 1.1*d)
cbar_super = plt.colorbar(contour_super, ax=ax_super)
cbar_super.set_label('|Delta p(x_s, y_s)| [dB]', fontsize=14)
...
contour_sub = ax_sub.pcolormesh(x_mesh, y_mesh,
                               ...
                               vmax=0, vmin=-30)
ax_sub.axis('equal')
ax_sub.set_title('Subcritical gust: |k_y| > k_y^crit', fontsize=16)
ax_sub.set_xlabel('x_s', fontsize=14)
ax_sub.set_yticks([-d, 0, +d])
ax_sub.set_yticklabels(['-d', '0', '+d'], fontsize=14)
ax_sub.set_xticks([-b, 0, b])
ax_sub.set_xticklabels(['-b', '0', '+b'], fontsize=14)
ax_sub.set_ylim(-1.1*d, 1.1*d)
cbar_sub = plt.colorbar(contour_sub, ax=ax_sub)
cbar_sub.set_label('|Delta p(x_s, y_s)| [dB]', fontsize=14)
...
title_dir_XZ = ax_dir_XZ.set_title('Normalised Directivity on y=0 plane (φ=0)',
                                   fontsize=18, pad=-55)
...
title_dir_YZ = ax_dir_YZ.set_title('Normalised Directivity on x=0 plane (φ=π/2)',
                                   fontsize=18, pad=-55)
...
if calc_nearfield:
    ...
    plt.xlabel("x/λ_0", fontsize=18)
    plt.ylabel("z/λ_0", fontsize=18)
    plt.axis('equal')
    plt.xlim([-3, 3])
    plt.ylim([-3, 3])
    cbar1 = plt.colorbar()
    cbar1.set_label('Ac. Pressure [a.u.]', fontsize=15)
    plt.title("Acoustic Field on y=0 plane", fontsize=18)
    ...
    plt.title("Acoustic Field on x=0 plane", fontsize=18)
